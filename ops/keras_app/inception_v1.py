...
- https://github.com/fchollet/deep-learning-models/blob/d83b434446e93977b595e5794ff6d685677059b5/inception_v1.py
- https://github.com/fchollet/deep-learning-models/pull/59/files
...
if __name__ == '__main__':
    inception = InceptionV1(include_top=True, weights='imagenet')
